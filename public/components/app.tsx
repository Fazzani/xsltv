      ...
      async () => {
        try {
          if (!this.state.settings.MyJsonId) {
            ...
            this.setState(
              { settings: { ...this.state.settings, MyJsonId } },
              async () => {
          ...
          <section className="row-section">
            ...
            <div className="container">
              ...
              <Route
                ...
                exact={true}
                render={() =>
                  this.state.filesFetched && <Home files={this.state.files} />
                }
              />
            </div>
            {this.state.loader && this.state.loader.loading ? (
              <Loader displayText={this.state.loader.text} />
            ) : null}
            <SnackBar />
            <NavBottom />
          </section>
