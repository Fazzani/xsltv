...
var descriptionpopupshint =
  "Check to enable the popups when the mouse is over a program.";
...
var popupsubtitlehint =
  "Check to show program subtitles in the program popups.";
var popupdescriptionlabel = "Description";
var popupdescriptionhint =
  "Check to show program descriptions in the program popups.";
...
var popupcategorieshint =
  "Check to show show categories or genres in the program popups.";
var popupstarratinglabel = "Star Rating";
var popupstarratinghint =
  "Check to show a graphical star rating in the program popups.";
...
var grabberhint =
  "Select your grabber to apply localized channel-name settings.";
