...
export default class XsltvProcessor {
    ...
    Init(xml, document) {
        ...
        const startDate = new Date(this.cy, this.cm - 1, this.cd, this.ch, 0, 0);
        ...
        let intMinutes = endDate.getMinutes();
        let endminutes = intMinutes < 10 ? "0" + intMinutes : endminutes = intMinutes;
